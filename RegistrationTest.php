...
<body>
    <div class="container">
        ...
        if (isset($_POST['btnRegister'])){
            ...
            $query = "INSERT INTO `breezequiz`(`First Name`, `Last Name`, `Email`, `Password`, `Country`) VALUES ('$fname','$lname','$email','$password','$country')";
            //execute the query
        ...
        <form method="post" action="">
            ...
            <input type="text" id="txtFName" name="txtFName" required><br>

            <label for="txtLName">Last Name:</label>
            <input type="text" id="txtLName" name="txtLName" required><br>
