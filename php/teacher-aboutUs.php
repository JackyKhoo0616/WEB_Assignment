...
<head>
    ...
    <link rel="stylesheet" href="../css/teacher-aboutUs.css" />
</head>
    ...
    <div class="banner">
        <div class="navbar">
            ...
            <ul>
                ...
                <li>
                    <a href="../html/teacher-viewLearning.html">Learning Material</a>
                </li>
                <li>
                    <a href="../html/teacher-progressTracker.html">Performance Monitoring</a>
                </li>
                <li>
                    <span class="no-a">
                    ...
                    <div class="sub-menu">
                        <ul>
                            <li>
                                <a href="../html/teacher-aboutUs.html">About Us</a>
                            </li>
