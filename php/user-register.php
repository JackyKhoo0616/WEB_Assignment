...
if (isset($_POST['btnRegister'])) {
	...
	if (mysqli_num_rows($resultStudents) > 0 || mysqli_num_rows($resultTeachers) > 0) {
		...
		if (mysqli_query($connection, $query)) {
			...
			echo '<script>alert("Registration Failed"")</script>' . mysqli_error($connection);
		}
	}
...
<body>
    <div class="wrapper">
        ...
        <p>
            Already Registered? <a href="../php/user-login.php">Login</a>
        </p>
        <form action="#" method="post">
            ...
            <div class="select-gender">
                <div class="radio">
                    <input type="radio" id="genderM" name="txtGender" value="Male" checked />
                    <label for="genderM">Male</label>
                </div>
                <div class="radio">
                    <input type="radio" id="genderF" name="txtGender" value="Female" />
            ...
            <div class="role">
                <p>Whats Your Role?</p>
                <input type="radio" id="roleS" name="role" value="Student" checked />
                <label for="roleS" class="roleS">Student</label>
                <div class="image">
                    <img src="../picture/student.png" class="hidden-1" />
                </div>
                <input type="radio" id="roleT" name="role" value="Teacher" />
                <label for="roleT" class="roleT">Teacher</label>
                <div class="image">
                    <img src="../picture/teacher.png" class="hidden-2" />
                </div>
            </div>
